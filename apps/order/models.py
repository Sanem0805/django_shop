...
def send_order_confirmation_mail(sender: Order, instance: Order, created: bool, **kwargs) -> None:
    if created:
        send_order_confirmation_mail.delay(instance.user.username, instance.address, instance.pk, instance.user.email)